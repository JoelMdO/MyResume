...
class FigureBottomColumnLeftMobile extends StatelessWidget {
  const FigureBottomColumnLeftMobile({super.key});
...
//PARALLELOGRAM ITEM
      ClipPath(
          ...
          child: SizedBox(
              width: 200, height: 390, child: Container(color: Colores.blue))),
