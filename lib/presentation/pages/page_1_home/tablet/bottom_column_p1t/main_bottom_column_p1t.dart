...
import 'package:resume/presentation/pages/page_1_home/tablet/bottom_column_p1t/figure_left_bottom_p1t.dart';
import 'package:resume/presentation/pages/page_1_home/tablet/bottom_column_p1t/figure_right_bottom_p1t.dart';
              ...
              child: const Stack(
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                        top: 45,
                        left: 0,
                        child: SizedBox(width: 200, child: ContactsHomePage())),
                  ]))),
    ]);
  }
}
